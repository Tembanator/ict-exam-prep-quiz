...
const features = [
  {
    ...
    description:
      "All 21 chapters of the 0417 ICT syllabus. Theory and practical questions aligned with Cambridge standards.",
    color: "indigo",
  },
  {
    icon: FileText,
    ...
    description:
      "Learn from your mistakes with comprehensive explanations for every question, helping you understand concepts deeply.",
    color: "blue",
  },
  {
    icon: Shield,
    ...
    description:
      "Secure, moderated learning environment. All content is verified by ICT experts to ensure accuracy.",
    color: "purple",
  },
  {
    icon: Zap,
    ...
    description:
      "Monitor your improvement across chapters with detailed analytics and performance metrics.",
    color: "orange",
  },
  {
    icon: Users,
    title: "Peer Learning",
    description:
      "Compare your performance and learn collaboratively in a safe, moderated environment.",
    color: "green",
  },
  {
    icon: CheckCircle,
    ...
    description:
      "Practice with timed quizzes and mock exams that mirror the real 0417 ICT exam format.",
    color: "red",
  },
];
      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-slate-600">
            Comprehensive features designed to help you master the 0417 ICT
            curriculum and ace your Cambridge exams.
          </p>
        </div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div
                  className={`inline-flex p-3 rounded-xl ${colorClass} transition-all duration-300 mb-4`}
                >
